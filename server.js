...
// Em produção, substitui '*' pelo teu domínio: 'https://o-teu-site.com'
app.use(cors({
    origin: '*',
...
// Responder a preflight requests (OPTIONS) de forma explícita
app.options('*', cors());
...
app.post('/api/index3/processar', (req, res) => {
    ...
    if (!respostas || !Array.isArray(respostas) || respostas.length === 0) {
        return res.status(400).json({ erro: 'Campo "respostas" inválido ou ausente.' });
    }
